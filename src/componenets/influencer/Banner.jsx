      ...
      <div className="container">
        <div className={InfluencerStyle.banner_content}>
          ...
          <div className={InfluencerStyle.btn_wrap}>
            <a className={`${InfluencerStyle.btn} btn`}>I'm a brand</a>
            <a className={`${InfluencerStyle.btn} btn`}>I'm and influencer</a>
          </div>
            ...
            <div className={InfluencerStyle.exclusive_wrap}>
              <div className={InfluencerStyle.exclusive_info}>
                <div className={InfluencerStyle.exclusive_info_item}>
                  <div className={InfluencerStyle.image_wrap}>
                    <img
                      ...
                      src="./images/aashna-hegde-img.png" loading="lazy"
                    />
                    <img
                      className={InfluencerStyle.star_card_overlay}
                      src="./images/aashna-hegde.png" loading="lazy"
                    />
                  </div>
                </div>
                <div className={InfluencerStyle.exclusive_info_item}>
                <div className={InfluencerStyle.image_wrap}>
                  <img
                    className={InfluencerStyle.star_card}
                    src="./images/awez-darbar-img.png" loading="lazy"
                  />
                  <img
                    className={InfluencerStyle.star_card_overlay}
                    src="./images/awez-darbar-overlay.png" loading="lazy"
                  />
                  </div>
                </div>
                <div className={InfluencerStyle.exclusive_info_item}>
                <div className={InfluencerStyle.image_wrap}>
                  <img
                    className={InfluencerStyle.star_card}
                    src="./images/third-card-img.png" loading="lazy"
                  />
                  <img
                    className={InfluencerStyle.star_card_overlay}
                    src="./images/third-card-icon.png" loading="lazy"
                  />
                  </div>
                </div>
              </div>
